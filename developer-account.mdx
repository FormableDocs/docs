...
<Steps>
  ...
  <Step title="Save the signing secret">
    Copy the signing secret when it's shown and store it as an environment secret. You'll use it to [verify webhook signatures](/webhooks/verifying-signatures). Formable does not show the secret again. You may rotate secrets if need be.

...
<Warning>
  Keep your signing secret confidential and store it as an environment secret. If you believe it has been exposed, rotate it from **Settings → Webhooks → Rotate secret**.
</Warning>

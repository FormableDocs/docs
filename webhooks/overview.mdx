...
<Steps>
  ...
  <Step title="Save your signing secret">
    Copy the signing secret shown once after registration and store it as an environment secret. You'll use it to [verify signatures](/webhooks/verifying-signatures). Formable does not show the secret again.
  </Step>
</Steps>
